...
import {classify} from "../topHotel/crawler.js";
...
const params = {
    ...
    QueueUrl: process.env.AWS_SQS_HOTELFLY_HOTEL_DETAILS_LINK_URL,
};
        ...
        if (err) {
            ...
            for (const msg of data.Messages) {
                ...
                try {
                    ...
                    await axios.post(process.env.HOTELFLY_API_HOST + '/hotel/detail', {"data": data})
